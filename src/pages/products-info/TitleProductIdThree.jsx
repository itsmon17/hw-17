...
const TitleProductIdThree = ({ id }) => {
  switch (id) {
    case "3":
      return (
        <DivStyle>
          <ImageApple src="https://www.istore.kg/media/products/iphone-14-pro-finish-select-202209-6-1inch-silver_I3rTGV5.webp" />
          <TitleDevice>
            <Button />
...
export default TitleProductIdThree;
