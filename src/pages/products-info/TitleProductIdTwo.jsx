...
const TitleProductIdTwo = ({ id }) => {
  switch (id) {
    case "2":
      return (
        <DivStyle>
          <ImageApple src="https://www.istore.kg/media/products/iphone-14-pro-finish-select-202209-6-1inch-gold_vKOx8mg.webp" />
          <TitleDevice>
            <Button />
...
export default TitleProductIdTwo;
